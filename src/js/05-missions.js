  ...
  const HOLD_THE_SUN_MISSIONS = [
    ...
    { id: 'm4', title: 'Fragile Balance', subtitle: 'Reach 105m.', kind: MissionKind.REACH_ALTITUDE, target: 105, perfectText: 'combo x6', toast: 'Balance found', nodeMeta: 'Ritual · Snow', biome: 'snow' },
    ...
    { id: 'm8', title: 'Scorched Sands', subtitle: 'Reach 125m.', kind: MissionKind.REACH_ALTITUDE, target: 125, perfectText: 'reach 125m', toast: 'Heat endured', nodeMeta: 'Ritual · Desert', biome: 'desert' },
    ...
    { id: 'm19', title: 'Cosmic Echo', subtitle: 'Reach 165m.', kind: MissionKind.REACH_ALTITUDE, target: 165, perfectText: 'reach 165m', toast: 'The void embraced', nodeMeta: 'Endurance · Cosmos', biome: 'cosmos' },
    ...
    { id: 'm22', title: 'Amber Leaves', subtitle: 'Reach 175m.', kind: MissionKind.REACH_ALTITUDE, target: 175, perfectText: 'Reach 420m', toast: 'Leaves dance', nodeMeta: 'Ritual · Autumn', biome: 'autumn' },
    ...
    { id: 'm25', title: 'Ocean Mirror', subtitle: 'Reach 190m.', kind: MissionKind.REACH_ALTITUDE, target: 190, perfectText: 'Flawless run', toast: 'The sky answered', nodeMeta: 'Ritual · Sea', biome: 'sea' },
    ...
    { id: 'm34', title: 'Digital Dream', subtitle: 'Reach 225m.', kind: MissionKind.REACH_ALTITUDE, target: 225, perfectText: 'Flawless run', toast: 'Grid overridden', nodeMeta: 'Ritual · Cyber', biome: 'cyber' },
    ...
    { id: 'm46', title: 'Perseus', subtitle: 'Reach 285m.', kind: MissionKind.REACH_ALTITUDE, target: 285, perfectText: 'Flawless run', toast: 'Hunter awakened', nodeMeta: 'Constellation · Orion', biome: 'orion' },
    ...
    { id: 'm50', title: 'The Zenith', subtitle: 'Reach 300m into pure light.', kind: MissionKind.REACH_ALTITUDE, target: 300, perfectText: 'Flawless run', toast: 'Transcendence', nodeMeta: 'Apex · Zenith', biome: 'zenith' }
  ];
