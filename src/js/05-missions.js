  ...
  const HOLD_THE_SUN_MISSIONS = [
    { id: 'm1', title: 'Still Night', subtitle: 'Reach 200m.', kind: MissionKind.REACH_ALTITUDE, target: 200, perfectText: 'zero near-fails', toast: 'The sky waits', nodeMeta: 'Ritual · Forest', biome: 'forest' },
    ...
    { id: 'm3', title: 'Autumn Winds', subtitle: 'Reach Combo x5.', kind: MissionKind.COMBO_TARGET, target: 5, perfectText: 'score 350m', toast: 'Leaves dance', nodeMeta: 'Ritual · Autumn', biome: 'autumn' },
    { id: 'm4', title: 'Fragile Balance', subtitle: 'Reach 400m.', kind: MissionKind.REACH_ALTITUDE, target: 400, perfectText: 'combo x6', toast: 'Balance found', nodeMeta: 'Ritual · Snow', biome: 'snow' },
    ...
    { id: 'm6', title: 'Rising Sky', subtitle: 'Reach 600m.', kind: MissionKind.REACH_ALTITUDE, target: 600, perfectText: 'zero near-fails', toast: 'The sky answered', nodeMeta: 'Ritual · Sea', biome: 'sea' },
    ...
    { id: 'm8', title: 'Scorched Sands', subtitle: 'Reach 800m.', kind: MissionKind.REACH_ALTITUDE, target: 800, perfectText: 'reach 900m', toast: 'Heat endured', nodeMeta: 'Ritual · Desert', biome: 'desert' },
    ...
    { id: 'm10', title: 'Storm Front', subtitle: 'Reach 1000m.', kind: MissionKind.REACH_ALTITUDE, target: 1000, perfectText: 'Max Combo x6', toast: 'Clouds pierced', nodeMeta: 'Ritual · Storm', biome: 'storm' },
    ...
    { id: 'm13', title: 'Midnight Depths', subtitle: 'Reach 1200m.', kind: MissionKind.REACH_ALTITUDE, target: 1200, perfectText: 'Max Combo x8', toast: 'Abyss illuminated', nodeMeta: 'Ritual · Abyss', biome: 'abyss' },
    ...
    { id: 'm15', title: 'Neon Grid', subtitle: 'Hold Dawn Line for 25s.', kind: MissionKind.ABOVE_DAWN_LINE, target: 25, perfectText: 'Reach 1400m', toast: 'Grid overridden', nodeMeta: 'Ritual · Cyber', biome: 'cyber' },
    { id: 'm16', title: 'Crystal Echoes', subtitle: 'Reach 1400m.', kind: MissionKind.REACH_ALTITUDE, target: 1400, perfectText: 'Max Combo x9', toast: 'Light fractured', nodeMeta: 'Ritual · Crystal', biome: 'crystal' },
    ...
    { id: 'm18', title: 'Stellar Nursery', subtitle: '80% Precision for 16s.', kind: MissionKind.STABILITY_TIME, target: 16, perfectText: 'Reach 1600m', toast: 'Stars born', nodeMeta: 'Ritual · Nebula', biome: 'nebula' },
    { id: 'm19', title: 'Cosmic Echo', subtitle: 'Reach 1600m.', kind: MissionKind.REACH_ALTITUDE, target: 1600, perfectText: 'reach 1700m', toast: 'The void embraced', nodeMeta: 'Endurance · Cosmos', biome: 'cosmos' },
    ...
    { id: 'm22', title: 'Amber Leaves', subtitle: 'Reach 1800m.', kind: MissionKind.REACH_ALTITUDE, target: 1800, perfectText: 'Reach 1900m', toast: 'Leaves dance', nodeMeta: 'Ritual · Autumn', biome: 'autumn' },
    ...
    { id: 'm25', title: 'Ocean Mirror', subtitle: 'Reach 2000m.', kind: MissionKind.REACH_ALTITUDE, target: 2000, perfectText: 'Flawless run', toast: 'The sky answered', nodeMeta: 'Ritual · Sea', biome: 'sea' },
    ...
    { id: 'm27', title: 'Sunbaked Dunes', subtitle: 'Hold Dawn Line for 35s.', kind: MissionKind.ABOVE_DAWN_LINE, target: 35, perfectText: 'Reach 2100m', toast: 'Heat endured', nodeMeta: 'Ritual · Desert', biome: 'desert' },
    { id: 'm28', title: 'Echoing Gorge', subtitle: 'Reach 2200m.', kind: MissionKind.REACH_ALTITUDE, target: 2200, perfectText: 'Max Combo x10', toast: 'Canyons glow', nodeMeta: 'Ritual · Canyon', biome: 'canyon' },
    ...
    { id: 'm31', title: 'Magma Core', subtitle: 'Reach 2400m.', kind: MissionKind.REACH_ALTITUDE, target: 2400, perfectText: 'Max Combo x11', toast: 'Dawn remembered', nodeMeta: 'Ritual · Volcano', biome: 'volcano' },
    ...
    { id: 'm33', title: 'Astral Stream', subtitle: 'Hold Dawn Line for 40s.', kind: MissionKind.ABOVE_DAWN_LINE, target: 40, perfectText: 'Reach 2500m', toast: 'Care becomes rhythm', nodeMeta: 'Ritual · Aether', biome: 'aether' },
    { id: 'm34', title: 'Digital Dream', subtitle: 'Reach 2500m.', kind: MissionKind.REACH_ALTITUDE, target: 2500, perfectText: 'Flawless run', toast: 'Grid overridden', nodeMeta: 'Ritual · Cyber', biome: 'cyber' },
    ...
    { id: 'm37', title: 'Purple Dust', subtitle: 'Reach 2600m.', kind: MissionKind.REACH_ALTITUDE, target: 2600, perfectText: 'Max Combo x12', toast: 'Stars born', nodeMeta: 'Ritual · Nebula', biome: 'nebula' },
    ...
    { id: 'm39', title: 'Cassiopeia', subtitle: 'Hold Dawn Line for 45s.', kind: MissionKind.ABOVE_DAWN_LINE, target: 45, perfectText: 'Reach 2700m', toast: 'Stars aligned', nodeMeta: 'Constellation · Ursa', biome: 'ursa' },
    { id: 'm40', title: 'Cygnus', subtitle: 'Reach 2700m.', kind: MissionKind.REACH_ALTITUDE, target: 2700, perfectText: 'Zero near-fails', toast: 'Hunter awakened', nodeMeta: 'Constellation · Orion', biome: 'orion' },
    ...
    { id: 'm42', title: 'Draco', subtitle: '80% Precision for 34s.', kind: MissionKind.STABILITY_TIME, target: 34, perfectText: 'Reach 2800m', toast: 'Stars aligned', nodeMeta: 'Constellation · Ursa', biome: 'ursa' },
    { id: 'm43', title: 'Pegasus', subtitle: 'Reach 2800m.', kind: MissionKind.REACH_ALTITUDE, target: 2800, perfectText: 'Max Combo x12', toast: 'Hunter awakened', nodeMeta: 'Constellation · Orion', biome: 'orion' },
    ...
    { id: 'm45', title: 'Andromeda', subtitle: 'Hold Dawn Line for 50s.', kind: MissionKind.ABOVE_DAWN_LINE, target: 50, perfectText: 'Reach 2900m', toast: 'Stars aligned', nodeMeta: 'Constellation · Ursa', biome: 'ursa' },
    { id: 'm46', title: 'Perseus', subtitle: 'Reach 2900m.', kind: MissionKind.REACH_ALTITUDE, target: 2900, perfectText: 'Flawless run', toast: 'Hunter awakened', nodeMeta: 'Constellation · Orion', biome: 'orion' },
    ...
    { id: 'm49', title: 'Eternity Gate', subtitle: 'Awaken 20 birds.', kind: MissionKind.BIRDS_THIS_RUN, target: 20, perfectText: 'Reach 3000m', toast: 'Stars born', nodeMeta: 'Ritual · Nebula', biome: 'nebula' },
    { id: 'm50', title: 'The Zenith', subtitle: 'Reach 3000m into pure light.', kind: MissionKind.REACH_ALTITUDE, target: 3000, perfectText: 'Flawless run', toast: 'Transcendence', nodeMeta: 'Apex · Zenith', biome: 'zenith' }
  ];
